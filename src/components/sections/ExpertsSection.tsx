...
export const ExpertsSection = () => {
  return (
    <section id="experts" className="px-4 py-8 md:py-12 bg-background">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-2xl md:text-3xl font-bold mb-8 text-center text-primary animate-fade-in">Meet the Experts</h2>
        
        {/* Sanjay Saraf Sir */}
        <Card className="mb-8 bg-card border-border shadow-lg hover:shadow-xl transition-all duration-500 transform hover:scale-105">
          <CardContent className="p-4 md:p-6">
            <div className="text-center mb-6">
              <h3 className="text-xl md:text-2xl font-bold text-primary mb-2">Sanjay Saraf Sir</h3>
              <p className="text-primary/70 text-xs md:text-sm mb-4">(CFA, FRM, MS-FINANCE, CTM, CPM, CIB, CIIA)</p>
              <div className="mx-auto mb-4 flex items-center justify-center">
                <img 
                  src="/lovable-uploads/d4d0d310-56b1-4c0b-aa01-c9205128432b.png" 
                  alt="Sanjay Saraf" 
                  className="rounded-full w-24 md:w-32 h-24 md:h-32 object-cover border-4 border-primary hover:scale-110 transition-transform duration-500 hover:border-primary/80"
                />
              </div>
            </div>
            
            <div className="space-y-4 text-foreground">
              <h4 className="text-lg md:text-xl font-semibold text-primary">A Visionary Leader in Finance, Trading, and Investment</h4>
              ...
              <div className="bg-accent p-3 md:p-4 rounded-lg border border-border hover:bg-accent/80 transition-colors duration-300">
                <h5 className="font-semibold text-primary mb-2 text-sm md:text-base">Key Achievements:</h5>
              ...
              <div className="bg-accent p-3 md:p-4 rounded-lg border border-border hover:bg-accent/80 transition-colors duration-300">
                <h5 className="font-semibold text-primary mb-2 text-sm md:text-base">SEBI Registered Research Analyst:</h5>
        ...
        <Card className="bg-card border-border shadow-lg hover:shadow-xl transition-all duration-500 transform hover:scale-105">
          <CardContent className="p-4 md:p-6">
            <div className="text-center mb-6">
              <h3 className="text-xl md:text-2xl font-bold text-primary mb-2">Guddu Kumar Sir (G.K. Shaw)</h3>
              <div className="mx-auto mb-4 flex items-center justify-center">
                <img 
            ...
            <div className="space-y-4 text-foreground">
              <h4 className="text-lg md:text-xl font-semibold text-primary">Trading with Expertise, Mentoring with Heart</h4>
              <p className="text-xs md:text-sm leading-relaxed">
              ...
              <div className="bg-accent p-3 md:p-4 rounded-lg border border-border hover:bg-accent/80 transition-colors duration-300">
                <h5 className="font-semibold text-primary mb-2 text-sm md:text-base">Expertise:</h5>
                <ul className="text-xs md:text-sm space-y-1">
